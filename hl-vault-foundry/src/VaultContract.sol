...
contract VaultContract {
    ...
    function settleWithdraw(uint256 id, uint64 pay1e6, address to) external {
        ...
        uint256 pps = pps1e18();
        uint64 maxPay = uint64(((r.shares * pps) / 1e18) / 1e12);
    ...
    function recallFromCoreAndSweep(uint64 amount1e6) external onlyOwner {
        ...
        // later owner should call handler.sweepToVault(amount1e6) after credit is available
    }
}
