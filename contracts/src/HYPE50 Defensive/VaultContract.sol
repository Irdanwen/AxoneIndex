...
contract VaultContract is ReentrancyGuard {
    ...
    function settleWithdraw(uint256 id, uint256 pay1e18, address to) external nonReentrant {
        ...
        uint256 feeHype1e18_settle = (r.feeBpsSnapshot > 0 && grossHype1e18 > 0)
            ...
            : 0;
        uint256 maxPay = grossHype1e18 - feeHype1e18_settle;
